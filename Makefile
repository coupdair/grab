...
##CImg.v1.2.5
OPT = -Dcimg_display=0 -Dcimg_debug=2 -Dcimg_use_vt100 -DGRAB_VERSION=\"$(version)\" $(OPT_FORMAT) -Dversion_cimg=$(version_cimg) $(OPT_NETCDF)
OPT = $(OPT_XWINDOWS) -Dcimg_display=1 -Dcimg_debug=2 -Dcimg_use_vt100 -DGRAB_VERSION=\"$(version)\" $(OPT_FORMAT) -Dversion_cimg=$(version_cimg) $(OPT_NETCDF)
##CImg.v1.4.9
#OPT = -Dcimg_display=0 -Dcimg_debug=2 -Dcimg_use_vt100 -DGRAB_VERSION=\"$(version)\" $(OPT_FORMAT) -Dversion_cimg=$(version_cimg)
#OPT = $(OPT_XWINDOWS)  -Dcimg_debug=2 -Dcimg_use_vt100 -DGRAB_VERSION=\"$(version)\" $(OPT_FORMAT) -Dversion_cimg=$(version_cimg) $(OPT_NETCDF)
